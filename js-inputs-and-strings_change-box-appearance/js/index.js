...
colorInput.addEventListener("click", () => {
  ...
  const newColorVal = `hsl( ${colorInputVal} 70 60)`;
  box.style.background = newColorVal;
});
...
rotationInput.addEventListener("click", () => {
    const rotationInputVal = rotationInput.value;
    const newRotationVal = `rotate( ${rotationInputVal}deg)`;
    box.style.transform = newRotationVal;
  });
